        ...
        var url = "";
    	 if ($scope.serviceForm.update == -1) {
    	        ...
    	        $http({
        			method: 'PUT',
        			url: url,
        			data: {'serviceName':$scope.serviceForm.serName, 'monthly':$scope.serviceForm.monthly,'id':$scope.serviceForm.id}
        			})
    	        ...
    	        $http({
        			method: 'POST',
        			url: url,
        			data: {'serviceName':$scope.serviceForm.serName, 'monthly':$scope.serviceForm.monthly}
        			})
